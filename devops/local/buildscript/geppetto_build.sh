...
APPLICATION='/ticketsampleapplication5821'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication5821-desktop:1.0'
...
helm install --name ticketsampleapplication5821-1734 ./helm
if [ $? -eq 0 ]; then
